...
- **API** — `PUT /invoices/:id/project-tag` to set/clear, `GET /project-tags` to list available values.
...
- Case-sensitive matching — "Alpha" and "alpha" are treated as different tags. Could be changed to citext if needed.
